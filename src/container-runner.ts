...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // not file mounts like Docker's /dev/null overlay. Credentials are injected
    // by the credential proxy at runtime and never exposed to containers, but
    // the .env file itself remains readable via the project mount.
